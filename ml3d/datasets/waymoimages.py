...
class WaymoImages(BaseDataset):
    ...
    def read_calib(path):
        ...
        Tr_velo_to_cam = WaymoImages._extend_matrix(Tr_velo_to_cam)
    ...
    def get_split(self, split):
        ...
        """
        return WaymoImagesSplit(self, split=split)
...
DATASET._register_module(WaymoImages)
